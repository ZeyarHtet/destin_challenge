...
String? getStoryTitle() {
  return StoryBrain.storyData[_storyNumber].storyTitle;
}

String? getStoryChoice1() {
  return StoryBrain.storyData[_storyNumber].choice1;
}

String? getStoryChoice2() {
  return StoryBrain.storyData[_storyNumber].choice2;
}
...
//TODO: Step 16 - Create a property called _storyNumber which starts with a value of 0. 
//This will be used to track which story the user is currently viewing.

//TODO: Step 17 - Create a method called nextStory(), it should not have any outputs 
...
//TODO: Step 23 - In nextStory() if the _storyNumber is equal to 3 or 4 or 5, that means it's the end of the game and it should call a method called restart() that resets the _storyNumber to 0.
